...
import {View, Text,TouchableOpacity, Pressable, Dimensions, SafeAreaView, ScrollView, StyleSheet, Image} from "react-native";
    ...
    const renderItem = ({item}) => {
        return (
            <TouchableOpacity
                ...
                style={{justifyContent: 'center', alignItems: 'center', marginVertical: 20, marginHorizontal: 20}}>
                <Image
